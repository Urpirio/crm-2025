  ...
  return (
    <div className="flex w-1/3 flex-col gap-5">
      <div className="flex flex-col gap-5">
        <h3 className="text-6xl text-white">El primer paso hacia el crecimiento <br /> de tu negocio</h3>
      ...
      <div className="flex flex-col gap-5">
        <article className="flex items-center gap-4">
          ...
          <div>
            <h3 className="font-semibold text-mg text-white/40">Correo asistencia </h3>
            <span className="font-light text-white">correouracloud@uracloud.com</span>
          </div>
        </article>
        <article className="flex items-center gap-4">
          <FiPhone className="text-2xl text-white" />
          <div>
            <h3 className="font-bold text-mg text-white/40">Número de teléfono URACLOUD</h3>
