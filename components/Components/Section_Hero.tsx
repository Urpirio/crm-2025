...
export default function Section_Hero() {
  return (
    <section className="lg:pt-40 pt-10 pb-10  bg-radial from-[#007AFF]  via-gray-50 to-white gap-10 flex flex-col items-center justify-center min-h-screen" id="inicio">
      <div className="flex flex-col items-center gap-5 ">
        <h1 className="xl:text-7xl lg:text-5xl text-xl md:text-4xl font-semibold mb-4 flex flex-col justify-center items-center gap-2">
          ...
          <div className="flex items-center sm:gap-4 gap-1">
            ...
            <motion.div
              ...
              className="border hidden sm:block z-0 bg-white rounded-2xl rotate-[-50deg] p-1 border-gray-300 shadow-2xs"
            >
              <motion.img
                src={Logo_Crm.src}
                alt="Logo"
        ...
        <Link href={"/#contactanos"} className="bg-blue-700 lg:text-xl text-md shadow-2xs hover:scale-105 transition-all duration-300 cursor-pointer text-white py-2 px-10 rounded-3xl">
          Contáctanos
        </Link>
      </div>
      <motion.div
